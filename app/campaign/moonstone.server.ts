...
export const players: Record<string, Player> = {
  jeff: {
    ...
    characters: [
      ...
      { cardId: "Olim", joined: "Feb", moonstones: 1, kills: 0, deaths: 1 },
      {
        cardId: "YoungJack",
        joined: "Feb",
        moonstones: 2,
  ...
  kevin: {
    ...
    faction: "Leshavult",
    characters: [
      { cardId: "Dranyer", joined: "Feb", moonstones: 1, kills: 0, deaths: 1 },
      {
        cardId: "Snag",
        joined: "Feb",
        moonstones: 0,
      ...
      { cardId: "Gump", joined: "Feb", moonstones: 2, kills: 0, deaths: 0 },
      {
        cardId: "TheRevenant",
        joined: "Feb",
        moonstones: 0,
  ...
  andy: {
    ...
    characters: [
      ...
      { cardId: "Danica", joined: "Feb", moonstones: 1, kills: 0, deaths: 1 },
      {
        cardId: "Zorya",
        joined: "Feb",
        moonstones: 0,
  ...
  richard: {
    ...
    characters: [
      ...
      { cardId: "TeeToe", joined: "Feb", moonstones: 3, kills: 0, deaths: 0 },
      {
        cardId: "Butterfingers",
        joined: "Mar",
        moonstones: 2,
  ...
  rob: {
    ...
    faction: "Dominion",
    characters: [
      { cardId: "Doug", joined: "Feb", moonstones: 3, kills: 2, deaths: 1 },
      {
        cardId: "Shabbaroon",
        joined: "Feb",
        retired: "Apr",
